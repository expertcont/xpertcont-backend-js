...
router.get('/cuentassimple/:id_usuario/:documento_id/:bpopup', obtenerTodasCuentasSimple);//bpopup = '1' cualquier caracter, indica que devuelve nombres genericos para manejo en frontend
//fin truco
