...
const router = Router();
const {obtenerRegistroTodos,obtenerRegistro,crearRegistro,actualizarRegistro,anularRegistro,eliminarRegistro, generarRegistro, generarComprobante, clonarRegistro} = require('../controllers/stock.controllers')

router.get('/ad_stock/:periodo/:id_anfitrion/:documento_id/:dia', obtenerRegistroTodos);//

router.get('/ad_stock/:periodo/:id_anfitrion/:documento_id/:cod/:serie/:num/:elem', obtenerRegistro);
