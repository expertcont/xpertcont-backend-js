...
const router = Router();
const {obtenerRegistroTodos,obtenerRegistro,crearRegistro,actualizarRegistro,anularRegistro,eliminarRegistro, generarRegistro, generarComprobante, clonarRegistro, obtenerMotivos, obtenerInventario, generarSaldosIniciales, obtenerTotalUnidadesStocks, obtenerKardex} = require('../controllers/stock.controllers')
...
router.get('/ad_stockinventario/:periodo/:id_anfitrion/:documento_id/:dia', obtenerInventario);//
router.get('/ad_stockkardex/:periodo/:id_anfitrion/:documento_id/:dia/:id_producto/:id_almacen', obtenerKardex);// New
router.get('/ad_stockunidades/:periodo/:id_anfitrion/:documento_id/:dia', obtenerTotalUnidadesStocks);//
