...
const router = Router();
const { obtenerTodosManifiestoDet, crearManifiestoDet, obtenerManifiestoCarga, obtenerManifiestoDet, obtenerManifiestoCabImpresion, obtenerManifiestoDetImpresion, obtenerPlacasManifiesto, obtenerLicenciasManifiesto, obtenerDestinosManifiesto } = require('../controllers/manifiesto.controllers');
