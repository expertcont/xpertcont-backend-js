...
const router = Router();
const { obtenerTodosManifiestoDet, crearManifiestoDet, obtenerManifiestoCarga, obtenerManifiestoDet, obtenerManifiestoCabImpresion, obtenerManifiestoDetImpresion } = require('../controllers/manifiesto.controllers');
