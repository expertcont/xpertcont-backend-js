...
const router = Router();
const {obtenerVentaDet,obtenerVentaDetItem,crearVentaDet,actualizarVentaDet,eliminarVentaDet, obtenerVentaDetTodos, obtenerVentaDetRef} = require('../controllers/ventadet.controllers')
